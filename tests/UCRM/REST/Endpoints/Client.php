...
final class Client extends Endpoint
{
    ...
    /**
     * @var string
     * @post-required `$this->clientType === $this::CLIENT_TYPE_COMMERCIAL`
     * @patch-required `$this->clientType === $this::CLIENT_TYPE_COMMERCIAL`
     */
    ...
    /**
     * @var string
     * @post-required `$this->clientType === $this::CLIENT_TYPE_RESIDENTIAL`
     * @patch-required `$this->clientType === $this::CLIENT_TYPE_RESIDENTIAL`
     */
    protected $firstName;
